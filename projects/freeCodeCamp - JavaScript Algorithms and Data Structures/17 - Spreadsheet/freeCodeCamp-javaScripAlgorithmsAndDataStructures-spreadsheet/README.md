Learn Functional Programming by Building a Spreadsheet by freeCodeCamp
...
This project covered concepts like the map(), find(), and includes() methods and the parseInt() function.
